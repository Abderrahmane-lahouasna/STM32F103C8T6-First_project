...
/****************************RCC Register*****************************/
#define Base_Adress_RCC        0x40021000
#define RCC_CR               *(( volatile unsigned long int*)Base_Adress_RCC + 0x00)  //0
#define RCC_CFGR             *(( volatile unsigned long int*)Base_Adress_RCC + 0x04)  //4
#define RCC_CIR              *(( volatile unsigned long int*)Base_Adress_RCC + 0x08)  //8
#define RCC_APB2RSTR         *(( volatile unsigned long int*)Base_Adress_RCC + 0x0C)  //12
#define RCC_APB1RSTR         *(( volatile unsigned long int*)Base_Adress_RCC + 0x10) //16
#define RCC_AHBENR           *(( volatile unsigned long int*)Base_Adress_RCC + 0x14)  //20
#define RCC_APB2ENR          *(( volatile unsigned long int*)Base_Adress_RCC + 0x18)  //24
#define RCC_APB1ENR          *(( volatile unsigned long int*)Base_Adress_RCC + 0x1C)  //28
#define RCC_BDCR             *(( volatile unsigned long int*)Base_Adress_RCC + 0x20)  //32
#define RCC_CSR              *(( volatile unsigned long int*)Base_Adress_RCC + 0x24)  //36
...
/*************************GPIOC Register***********************************/
#define  Base_adress_GPIOC     0x40011000
#define GPIOC_CRL            *(( volatile unsigned long int*)Base_adress_GPIOC + 0x00)
#define GPIOC_CRH            *(( volatile unsigned long int*)Base_adress_GPIOC + 0x04)
#define GPIOC_IDR            *(( volatile unsigned long int*)Base_adress_GPIOC + 0x08)
#define GPIOC_ODR            *(( volatile unsigned long int*)Base_adress_GPIOC + 0x0C)
#define GPIOC_BSRR           *(( volatile unsigned long int*)Base_adress_GPIOC + 0x10)
#define GPIOC_BRR            *(( volatile unsigned long int*)Base_adress_GPIOC + 0x14)
#define GPIOC_LCKR           *(( volatile unsigned long int*)Base_adress_GPIOC + 0x18)
/*************************GPIOD Register***********************************/
...
typedef struct{
 volatile unsigned long int CRL   ;//0x00
 volatile unsigned long int CRH   ;//0x04
 volatile unsigned long int IDR   ;//0x08
 volatile unsigned long int ODR   ;//0x0C
 volatile unsigned long int BSRR  ;//0x10
 volatile unsigned long int BRR   ;//0x14
 volatile unsigned long int LCKR  ;//0x18

}GPIO_str;
#define GPIOA   ((GPIO_str *)Base_adress_GPIOA)
#define GPIOB   ((GPIO_str *)Base_adress_GPIOB)
#define GPIOC   ((GPIO_str *)Base_adress_GPIOC)
#define GPIOD   ((GPIO_str *)Base_adress_GPIOD)
#define GPIOE   ((GPIO_str *)Base_adress_GPIOE)
#define GPIOF   ((GPIO_str *)Base_adress_GPIOF)
#define GPIOG   ((GPIO_str *)Base_adress_GPIOG)

typedef struct{
volatile unsigned long int	   CR      ;//0x00
volatile unsigned long int     CFGR    ;//0x04
volatile unsigned long int     CIR     ;//0x08
volatile unsigned long int     APB2RSTR;//0x0C
volatile unsigned long int     APB1RSTR;//0x10
volatile unsigned long int     AHBENR  ;//0x14
volatile unsigned long int     APB2ENR ;//0x18
volatile unsigned long int     APB1ENR ;//0x1C
volatile unsigned long int     BDCR    ;//0x20
volatile unsigned long int     CSR     ;//0x24

}RCC_str;
#define RCC          ((RCC_str*)Base_Adress_RCC)
